...
bool isPrePriorityDemo(const al::CameraStartInfo& startInfo) {
    return startInfo.mPrePriorityType == al::CameraTicket::Priority_Demo;
}

bool isPrePriorityDemo2(const al::CameraStartInfo& startInfo) {
    return startInfo.mPrePriorityType == al::CameraTicket::Priority_Demo2;
}

bool isPrePriorityDemoTalk(const al::CameraStartInfo& startInfo) {
    return startInfo.mPrePriorityType == al::CameraTicket::Priority_DemoTalk;
}

bool isPrePriorityDemoAll(const al::CameraStartInfo& startInfo) {
    return (startInfo.mPrePriorityType - al::CameraTicket::Priority_Demo) < 2;
}

bool isPrePriorityEntranceAll(const al::CameraStartInfo& startInfo) {
    return (startInfo.mPrePriorityType == al::CameraTicket::Priority_Entrance) |
           (startInfo.mPrePriorityType == al::CameraTicket::Priority_Unknown);
}

bool isPrePriorityPlayer(const al::CameraStartInfo& startInfo) {
    return startInfo.mPrePriorityType == al::CameraTicket::Priority_Player;
}

bool isEqualPreCameraName(const al::CameraStartInfo& startInfo, const char* compareName) {
    const char* name = startInfo.mCameraName;
